...
# اعطای دسترسی اجرایی به صورت قطعی با مسیر مطلق
chmod +x "$BASE_DIR/nordx-manager.sh"

# ساخت میان‌بر در مسیر اصلی اجرایی لینوکس
ln -sf "$BASE_DIR/nordx-manager.sh" /usr/bin/nordx
